...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
  <tr>
    <td height="30" background="images/bg_list.gif"><div  style="padding-left:10px; font-weight:bold; color:#FFFFFF">增加相册</div></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="stable" >
      <tr >
        <td width="11%" height="28" align="right" class="td"><font color="#FF0000">*</font>相册标题</td>
        <td width="89%"  class="td"><input name="title" type="text" size="40"  /></td>
      </tr>
      <tr>
        <td width="11%" height="13" align="right" class="td"><font color="#FF0000">*</font>相册分类</td>
        <td class="td"><select name="ssfl" id="select">
          ...
          <tr>
        <td width="11%" height="12" align="right" class="td">超级连接</td>
        <td class="td"><input name="url" type="text" value="#" size="40" /> 
          请填写完整地址，例:QQ空间http://495573637.qzone.qq.com/ </td>
      </tr>
    <tr>
    <TD  height=30 align="right" valign="middle" class="td">缩略图</td>
      <td colspan="3" class="td"><input name="img" type="text" id="img" size="40" value="" />
        <input name="button" type="button" class="btn2" id="flash" value="选取已上传图片" /></td>
    </tr>
	<tr>
        <td width="11%" height="12" align="right" class="td"><font color="#FF0000">*</font>图片组</td>
...
objDrop.selectedIndex = nIndex;
    ...
    <tr>
    <TD height="30" align="right" class="td">上传图片</td>
     ...
     <tr>
        <td height="25" align="right" class="td">照片内容</td>
...
conn.close
set rs=nothing
Response.Write "<script>alert('增加成功，点击继续增加！');window.location.href='admin_photo.asp';</script>"
end if
%>