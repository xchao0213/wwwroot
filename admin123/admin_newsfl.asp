...
<td width="29%" align="center" class="td"><input name="url" type="text" value="/News/Newslist.asp?id=<%=rs("id")%>" size="20"/> 
[<a href="/News/Newslist.asp?id=<%=rs("id")%>" target="_blank" style="color:#003399">访问</a>]</td>
...
<td width="7%" align="center" class="td"><input type="button" name="Submit" value="删除" onClick="javascript:if(confirm('确定删除？删除后不可恢复!')){window.location.href='admin_newsfl.asp?act=del&id=<%=rs("id")%>';}else{history.go(0);}"  class="btn"/></td>
</tr></form>
<% rs.movenext 
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
<form action="admin_newsfl.asp?add=ok" method="post" name="add">
  <tr>
