...
<td width="22%" height="25" align="center" class="td">分类名称</td>
<td width="39%" align="center" class="td">地 址</td>
<td width="17%" align="center" class="td">排 序</td>
<td width="8%" align="center" class="td">修 改</td>
<td width="8%" align="center" class="td">删 除</td>
</tr></thead>
<%	
...
<tr>
<td width="6%" align="center" class="td"><input name="id" type="hidden" value="<%=rs("id")%>"/>
<input type="text" style="text-align:center;width:40px" value="<%=rs("id")%>" readonly/></td>
<td width="22%" height="25" align="center" class="td"><input name="title" type="text" size="15"  value="<%=rs("title")%>"/></td>
<td width="39%" align="center" class="td"><input name="url" type="text" value="/Download/?id=<%=rs("id")%>" size="20"/> 
[<a href="/Download/?id=<%=rs("id")%>" target="_blank" style="color:#003399">访问</a>]</td>
<td width="17%" align="center" class="td"><input name="px_id" type="text" value="<%=rs("px_id")%>" style="text-align:center; width:40px"/></td>
<td width="8%" align="center" class="td"><input type="submit" name="button2" id="button2" value="修改"  class="btn"/></td>
<td width="8%" align="center" class="td"><input type="button" name="Submit" value="删除" onClick="javascript:if(confirm('确定删除？删除后不可恢复!')){window.location.href='?act=del&id=<%=rs("id")%>';}else{history.go(0);}"  class="btn"/></td>
</tr></form>
<%rs.movenext 
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
<form action="admin_download_fl.asp?add=ok" method="post" name="add">
  <tr>
  ...
  <tr>
    <td bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="stable" >
      <tr>
        <td width="13%" height="25" align="right" class="td">分类名称</td>
        <td width="87%"  class="td"><input name="title" type="text" size="30"  /></td>
      </tr>
      <tr>
        <td width="13%" height="25" align="right" class="td">排序ID</td>
...
rs.update 
rs.close 
response.Write("<script language=""javascript"">alert(""当前分类修改成功了！"");window.location.href='admin_download_fl.asp';</script>")
end if
%> 
<%
