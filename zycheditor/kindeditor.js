...
K.options = {
	...
	htmlTags : {
		...
		img : ['id', 'class', 'src', 'width', 'height', 'border', 'alt', 'data-original', 'title', 'align', '.width', '.height', '.border'],
...
_extend(KCmd, {
	...
	insertimage : function(url, title, width, height, border, align, rel) {
		title = _undef(title, '');
		border = _undef(border, 0);
		var html = '<a href="' + _escape(url) + '" rel="sexylightbox[group1]">';
		...
		html += '/></a>';
		//if (title) {
        //    html += '<p style="font-family:Microsoft YaHei; text-align:center"';
        //    if (align) {
        //    html += ' align="' + _escape(align) + '"';
        //    }
        //    html += '>' + _escape(title) + '</p>';
        // }
