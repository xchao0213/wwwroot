...
fltitle=fl("title")
if html=0 then
fldh="<a href="""&dir&"Culture/"&Newsfl&""&Separated&""&fl("id")&"."&HTMLName&""">"&fl("title")&"</a>"
else
fldh="<a href="""&dir&"Fengfa/Fengfalist.asp?id="&fl("id")&""">"&fl("title")&"</a>"
end if%>
...
<div class="bar"><b><%=zych_pd_class(wurl)%></b><span>当前位置：<a href="../">首页</a><a href="<%=dir%>Fengfa/"><%=zych_class(wurl)%></a><%=fldh%></span></div>
<div class="w_650 fl">
<dl class="list">
...
if html=0 then
url=""&dir&"Culture/"&ShowNews&Separated&rs("id")&"."&HTMLName&""
elseif html=1 then
url=""&dir&"Fengfa/ShowFengfa.asp?id="&rs("id")&""
end if
else
url=""&rs("url")&""
end if
