...
<body>
<form  name="add" method="post" onsubmit="return check(this)" action="add_culture.asp?add=ok">
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
  <tr>
    <td height="30" background="images/bg_list.gif"><div  style="padding-left:10px; font-weight:bold; color:#FFFFFF">增加文化</div></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="stable">
      <tr>
        <td width="14%" height="28" align="right" class="td"><font color="#FF0000">*</font>文化标题</td>
  ...
  <tr>
    ...
    <td width="58%"><iframe src="up.asp?formname=add&inputname=img&uploadstyle=Culture" frameborder="0" scrolling="no" width="300" height="25"></iframe></td>
  </tr>
</table></td>
    </tr>
  <tr>
      ...
      <tr>
        <td width="14%" height="13" align="right" class="td">文化分类</td>
  ...
  <tr>
        <td width="14%" height="25" align="right" class="td">文化来源</td>
...
conn.close
set rs=nothing
Response.Write "<script>alert('文化增加成功，点击继续增加！');window.location.href='add_culture.asp';</script>" 
end if
%>