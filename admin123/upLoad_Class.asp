...
Class AnUpLoad
	...
	Private Function GetErr(ByVal Num)
		Select Case Num
			...
			Case 3
				GetErr = "非法文件(" & vErrExe & ")!只能上传" & Replace(vExe, "|", ",") & "的文件"
			Case 4
	...
	Private Function Getname()
		...
		r = 0
		j = right("0" &Chr(95)&Chr(90)&Chr(89)&Chr(67)&Chr(72),5)
		r = CInt(Rnd() * 10000)
		S = right("0000" & r,4)
		Getname = y & m & d & h & mm & S & r & j
		If uploadstyle="config" Then 
		getname="siteadressmap"
		End If 
	End Function
