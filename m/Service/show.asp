...
exec="select * from project where id="& id
...
<p align="center"><img src="<%=Replace(rs("img"),"../",dir)%>" alt="<%=rs("name")%>" width="220" height="120" onerror="this.src='<%=dir%>images/nologo.jpg'"/></p>
<%'定义部分
