...
<%call chkAdmin(10)
exec="select * from fengfa where id="& request.QueryString("id") 
...
<body>
<form  name="add" method="post" onsubmit="return check(this)" action="xiugai_fengfa.asp?id=<%=rs("id")%>&modification=ok">
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
  <tr>
    <td height="30" background="images/bg_list.gif"><div  style="padding-left:10px; font-weight:bold; color:#FFFFFF">修改园区</div></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="stable">
      <tr>
        <td width="13%" height="28" align="right" class="td"><font color="#FF0000">*</font>园区标题</td>
  ...
  <tr>
    ...
    <td width="59%"><iframe src="up.asp?formname=add&inputname=img&uploadstyle=Culture" frameborder="0" scrolling="no" width="300" height="25"></iframe></td>
     ...
     <tr>
      ...
      <tr>
        <td width="13%" height="13" align="right" class="td">园区分类</td>
     ...
     <tr>
        <td width="13%" height="25" align="right" class="td">园区来源</td>
...
if ssfl=""  then 
response.Write("<script language=javascript>alert('园区分类不能为空!');history.go(-1)</script>") 
response.end 
end if
if body=""  then 
...
rs.update 
rs.close 
response.write "<script>alert('园区修改成功！');window.location.href='admin_fengfa.asp';</script>" 
end if
%> 
