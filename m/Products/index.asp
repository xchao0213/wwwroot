...
<div><a href="Show.asp?id=<%=rs("id")%>"><img src="<%=img%>" width="270" height="150" alt="<%=rs("title")%>" onerror="this.src='<%=dir%>images/nologo.jpg'"/></a></div>
<p class="t"><a href="Show.asp?id=<%=rs("id")%>"><%=rs("title")%></a></p>
