...
<body>
<form  name="add" method="post" onsubmit="return check(this)" action="add_fengfa.asp?add=ok">
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
  <tr>
    <td height="30" background="images/bg_list.gif"><div  style="padding-left:10px; font-weight:bold; color:#FFFFFF">增加园区</div></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="stable">
      <tr>
        <td width="14%" height="28" align="right" class="td"><font color="#FF0000">*</font>园区标题</td>
  ...
  <tr>
    ...
    <td width="58%"><iframe src="up.asp?formname=add&inputname=img&uploadstyle=Fengfa" frameborder="0" scrolling="no" width="300" height="25"></iframe></td>
  </tr>
</table></td>
    </tr>
  <tr>
      ...
      <tr>
        <td width="14%" height="13" align="right" class="td">园区分类</td>
  ...
  <tr>
        <td width="14%" height="25" align="right" class="td">园区来源</td>
...
%> <input name="zz" type="text" value="<%=rs("zsname")%>" size="30"  /></td>
     ...
     <tr>
        <td height="25" align="right" class="td"><font color="#FF0000">*</font>园区内容</td>
...
if title=""  then 
response.Write("<script language=javascript>alert('园区标题不能为空!');history.go(-1)</script>") 
response.end 
end if
if body=""  then 
response.Write("<script language=javascript>alert('园区内容不能为空!');history.go(-1)</script>") 
response.end 
end if
rs.addnew
if local=1 then
	...
	uploadpath="../uploadfile/image/Fengfa/"
...
conn.close
set rs=nothing
Response.Write "<script>alert('园区增加成功，点击继续增加！');window.location.href='add_fengfa.asp';</script>" 
end if
%>