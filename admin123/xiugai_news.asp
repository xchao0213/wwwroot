...
<body>
<form  name="add" method="post" onsubmit="return check(this)" action="xiugai_news.asp?id=<%=rs("id")%>&modification=ok">
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
  ...
  <tr>
    <td bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="stable">
      <tr>
        <td width="13%" height="28" align="right" class="td"><font color="#FF0000">*</font>新闻标题</td>
 ...
 <tr>
  ...
  <tr>
    ...
    <td width="59%"><iframe src="up.asp?formname=add&inputname=img&uploadstyle=News" frameborder="0" scrolling="no" width="300" height="25"></iframe></td>
  </tr>
</table>      </td>
    </tr>
     ...
     <tr>
      ...
      <tr>
        <td width="13%" height="13" align="right" class="td">新闻分类</td>
     ...
     <tr>
        <td width="13%" height="25" align="right" class="td">新闻来源</td>
...
if ssfl=""  then 
response.Write("<script language=javascript>alert('新闻分类不能为空!');history.go(-1)</script>") 
response.end 
end if
if body=""  then 
