...
fldh="<a href="""&dir&"Culture/Culturelist.asp?id="&fl("id")&""">"&fl("title")&"</a>"
end if%>
...
<div class="bar"><b><%=zych_pd_class(wurl)%></b><span>当前位置：<a href="../">首页</a><a href="<%=dir%>Culture/"><%=zych_class(wurl)%></a><%=fldh%></span></div>
<div class="w_650 fl">
<dl class="list">
