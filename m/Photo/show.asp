...
<%
 ...
 rstmp.open "select top 1 id, title from [Photo] where id>"&request.QueryString("id")&" and ssfl="&daohang("id")&" order by id asc",conn,1,1
 ...
 rstmp.close
 rstmp.open "select top 1 id, title from [Photo] where id<"&request.QueryString("id")&" and ssfl="&daohang("id")&" order by id desc"
 if not rstmp.eof then
